  ...
  return (
    <div className='about'>
      <div className='about-left'>
        <img src={images.about} alt="" className='about' />
        <img src={images.playIcon} alt="" className='play-icon' onClick={()=>{setplayState(true)}}/>
      </div>
      <div className='about-right'>
        <h3>ABOUT UNIVERSITY</h3>
        <h2>Nurturing Tomorrow's Leading Future</h2>
